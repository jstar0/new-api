...
func InitOptionMap() {
	...
	common.OptionMap[LeaderboardSettingOptionKey] = DefaultLeaderboardSettingsJSONString()
	common.OptionMap[UsageRewardSettingOptionKey] = DefaultUsageRewardSettingsJSONString()
	...
	common.OptionMap["UserRelayConcurrencyLimit"] = strconv.Itoa(setting.UserRelayConcurrencyLimit)
	common.OptionMap["UserRelayConcurrencyLimitUser"] = setting.UserRelayConcurrencyLimitUser2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserRelayConcurrencyLimit":
		setting.UserRelayConcurrencyLimit, _ = strconv.Atoi(value)
	case "UserRelayConcurrencyLimitUser":
		err = setting.UpdateUserRelayConcurrencyLimitUserByJSONString(value)
	case "RetryTimes":
