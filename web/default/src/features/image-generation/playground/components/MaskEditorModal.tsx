...
export default function MaskEditorModal() {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className='z-20 flex flex-none items-center justify-between border-b border-gray-200 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-950'>
          <div className='flex items-center gap-3'>
            ...
            <div className='relative flex items-center gap-1.5'>
              ...
              {showMaskInfo && (
                <div className='absolute top-full left-0 mt-2 w-64 rounded-xl border border-gray-200/80 bg-white px-3 py-2 text-xs leading-5 text-gray-600 shadow-lg dark:border-white/[0.08] dark:bg-gray-900 dark:text-gray-300'>
          ...
          <div className='flex items-center gap-2'>
            {maskDraft?.targetImageId === imageId && (
              <button
                ...
                className='flex h-8 items-center gap-1.5 rounded-lg bg-red-500 px-4 text-sm font-medium text-white transition hover:bg-red-600'
              >
                移除遮罩
              </button>
            )}
            <button
              ...
              className='flex h-8 items-center gap-1.5 rounded-lg bg-blue-500 px-4 text-sm font-medium text-white transition hover:bg-blue-600 disabled:opacity-50'
            >
              {isSaving ? '保存中...' : '保存'}
            </button>
          </div>
            ...
            <div className='flex items-center gap-1.5 sm:gap-3'>
              ...
              >
                <button
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-xl border transition-all sm:h-[46px] sm:w-[46px] sm:rounded-[14px] ${showBrushControls ? 'border-blue-200 bg-blue-50 text-blue-600 dark:border-gray-600 dark:bg-[#323338] dark:text-blue-400' : 'border-gray-200/80 bg-white text-gray-700 hover:bg-gray-50 dark:border-[#323338] dark:bg-transparent dark:text-[#e0e0e0] dark:hover:border-gray-500'}`}
                  disabled={!isReady || isSaving}
                  title='调节笔刷大小'
                >
      ...
      {showBrushControls &&
        ...
        createPortal(
          <div
            ...
            className='fixed z-[100] h-44 w-14 -translate-x-1/2 rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800'
          ...
          >
            <input
              ...
              className='absolute top-1/2 left-1/2 h-5 w-32 -translate-x-1/2 -translate-y-1/2 -rotate-90 cursor-ns-resize accent-blue-500'
              disabled={!isReady || isSaving}
            />
          </div>,
          document.body
