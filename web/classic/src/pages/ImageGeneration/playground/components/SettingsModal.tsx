...
const APP_VERSION_LABEL =
  typeof __APP_VERSION__ === 'undefined' ? 'turboapi' : __APP_VERSION__
                  ...
                  <div>
                    ...
                    <div ref={profileMenuRef} className='relative'>
                      <button
                        ...
                        className='flex w-full min-w-0 items-center justify-between gap-2 rounded-xl border border-gray-200/70 bg-white/60 px-3 py-2 text-sm text-gray-700 transition outline-none hover:bg-gray-50 dark:border-white/[0.08] dark:bg-white/[0.03] dark:text-gray-200 dark:hover:bg-white/[0.06]'
