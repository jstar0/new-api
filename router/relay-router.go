...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.UserRelayConcurrencyLimit(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.UserRelayConcurrencyLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.UserRelayConcurrencyLimit(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.UserRelayConcurrencyLimit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.UserRelayConcurrencyLimit(), middleware.Distribute())
	{
