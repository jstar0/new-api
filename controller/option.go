...
func UpdateOption(c *gin.Context) {
	...
	case model.UsageRewardSettingOptionKey:
		_, err = model.ParseUsageRewardSettings(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
	...
	case model.LeaderboardSettingOptionKey:
		_, err = model.ParseLeaderboardSettings(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
